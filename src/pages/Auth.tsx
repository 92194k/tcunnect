    ...
    <div className="min-h-screen bg-gradient-to-br from-[#F0EBFF] via-white to-[#FFE8F0] flex items-center justify-center p-4 font-display">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <button onClick={() => onNavigate("landing")} className="inline-block mb-6">
            <Logo size="lg" />
          </button>
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-slate-100 p-8">
          ...
          <div className="space-y-3 mb-6">
            <button
              onClick={() => window.alert("Google sign-in isn't set up yet — it needs a Google Cloud OAuth app connected in your Supabase project's Auth settings.")}
            ...
            <button
              onClick={() => window.alert("Facebook sign-in isn't set up yet — it needs a Facebook Developer app connected in your Supabase project's Auth settings.")}
              className="w-full flex items-center justify-center gap-3 border-2 border-slate-200 rounded-xl py-3 text-sm font-semibold text-slate-700 hover:border-[#1877F2] hover:text-[#1877F2] transition-all"
            >
